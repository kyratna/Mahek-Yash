...
- **Meet the Families (`#couple`)**: Traditional royal Indian wedding lineage cards with classical Sanskrit shloka (*Twameva Mata Cha Pita Twameva...*), `॥ मंगलम् ॥` (*Auspicious Beginning*) & `॥ युग्म ॥` (*Sacred Union*) symbols rendered in pure HTML typography with sacred words in royal burgundy and ceremonial dandas in gold, unified Cormorant Garamond italic typography across all contextual lines, and luxury double borders with burgundy inner dashed accents.
